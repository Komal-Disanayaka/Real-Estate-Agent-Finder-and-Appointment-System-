                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header bg-info text-white">
                                    <h5>Find Your Perfect Agent</h5>
                                </div>
                                <div class="card-body">
                                    <p>Search through our database of professional real estate agents.</p>
                                    <a href="${pageContext.request.contextPath}/agent/list" class="btn btn-outline-info">Browse Agents</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>View our latest property listings in your area.</p>
                                    <a href="${pageContext.request.contextPath}/property/list" class="btn btn-outline-success">View Properties</a>
                                </div>
                            </div>
                        </div>
                    </div>
