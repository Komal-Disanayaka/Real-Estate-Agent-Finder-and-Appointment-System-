                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="agentType">
                                        Agent
                                    </label>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleAgentFields() {
        agentFields.style.display = agentType.checked ? 'block' : 'none';
        
        // Toggle required attribute on agent-specific fields
        const agentInputs = agentFields.querySelectorAll('input');
        agentInputs.forEach(input => {
            input.required = agentType.checked;
        });
    }
    
    agentType.addEventListener('change', toggleAgentFields);
    clientType.addEventListener('change', toggleAgentFields);
